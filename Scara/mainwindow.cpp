...
void MainWindow::makePlot()
{
  ...
  /* ui->plotZAxis->xAxis->setBasePen(QPen(Qt::white, 1));
   ...
   ui->plotZAxis->yAxis->setLabelColor(Qt::white);*/
    ...
    ui->plotXAxis->yAxis->setLabel("Pozycja enkodera J1");
   ...
   // ui->plotYAxis->addGraph();
    ...
    ui->plotYAxis->yAxis->setLabel("Pozycja enkodera J2");
...
{
    std::stringstream msg;
    msg <<"E 0 0 0 55R";//tutaj będzie 1600 lub 7200 żeby przypisać pozycję 0 serwa
